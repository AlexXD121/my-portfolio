...
export const SOCIAL_LINKS = [
  { name: 'GitHub', url: 'https://github.com/dhavalrathva', icon: 'GitHub' },
  { name: 'LinkedIn', url: 'https://linkedin.com/in/dhavalrathva', icon: 'LinkedIn' },
  { name: 'Twitter', url: 'https://twitter.com/dhavalrathva', icon: 'Twitter' },
