...
const SOCIALS = [
  { label: 'GitHub', icon: '🐙', href: 'https://github.com/dhavalrathva' },
  { label: 'LinkedIn', icon: '🔗', href: 'https://linkedin.com/in/dhavalrathva' },
  { label: 'Twitter', icon: '🐦', href: 'https://twitter.com/dhavalrathva' },
  { label: 'Email', icon: '✉️', href: 'mailto:dmr19104@gmail.com' },
];
